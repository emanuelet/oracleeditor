...
/*
  ...
  Revision 1.21  27/10/2014
  - add jqeury.tablesorter
  - revisited css for readability
...
$version = trim(substr('$Revision: 1.21 $', 10, -1));
...
if ($doexport)
  ...
  if ($ok)
    ...
    if ($_SESSION[ 'exportformat' ] == 'xml')
      ...
      echo "<!-- Generated by OracleEditor.php (https://github.com/emanuelet/oracleeditor) -->\n";
    ...
    elseif ($_SESSION[ 'exportformat' ] == 'html')
      ...
      <meta name="generator" content="OracleEditor.php (https://github.com/emanuelet/oracleeditor)">
    ...
    elseif ($_SESSION[ 'exportformat' ] == 'html')
      ...
      <p>HTML generated by OracleEditor.php</a> <?php echo $version; ?> &copy; 2014 by <a href="http://emanueletonello.altervista.org/" title="Emanuele Tonello's homepage">Emanuele Tonello</a> &lt;<a href="mailto:emanueletonello@gmail.com" title="Send e-mail to Emanuele Tonello">emanueletonello@gmail.com</a>&gt;</p>
      </body>
      </html>
...
if ($conn == false)
  ...
  <tr>
    <td colspan="2">Browse and edit your Oracle database records ...</td>
  </tr>
  </table>
  ...
  if ($_SESSION[ 'entrymode' ] == 'popups')
    ...
    echo ' <input type="text" name="where" value="' . htmlspecialchars($_SESSION[ 'where' ]) . '" size="40" title="Enter GROUP BY or ORDER BY clauses here" /> <b>;</b>';
    }
  else
    ...
    <textarea name="sql" rows="5" cols="120" title="Enter any SQL statement here: SELECT, INSERT, UPDATE, DELETE, ALTER, DROP..."><?php echo htmlspecialchars($_SESSION[ 'sql' ]); ?></textarea>
  ...
  if ((($_SESSION[ 'table' ] != '') || ($_SESSION[ 'sql' ] != '')) && (! $dont_execute))
    ...
    if ($statementtype == 'SELECT')
      ...
      if ($exportmode)
        ...
        echo '<table id="resulttable" class="resultgrid">' . "\n";
        echo '<thead>' . "\n";
        ...
        foreach ($columns as $columnname => $column)
          echo '<th title="Click to Order">' . $columnname . '<br /><span id="header_subtitle">(' . $column[ 'type' ] . ', ' . $column[ 'size' ] . ')</span></th>' . "\n";
  ...
  echo '<td class="option_footer" valign="top"><a href="' . $_SERVER[ 'PHP_SELF' ] . '?sid=' . $sid . '&dropcache=1" title="After altering tables, click here to force a re-read of table definitions">Drop DDL cache</a></td>' . "\n";

  // "Debug" link

  echo '<td class="option_footer" valign="top"><a title="Click here to switch SQL statement logging on or off" href="' . $_SERVER[ 'PHP_SELF' ] . '?sid=' . $sid . '&debug=';
  ...
  echo '<td class="option_footer" valign="top">Oracle environment variables:<br />';
...
<footer>
  <a href="https://github.com/emanuelet/oracleeditor" title="OracleEditor.php homepage">OracleEditor.php</a> <?php echo $version; ?> &copy; 2014 by <a href="http://emanueletonello.altervista.org/" title="Emanuele Tonello's homepage">Emanuele Tonello</a> &lt;<a href="mailto:emanueletonello@gmail.com" title="Send e-mail to Emanuele Tonello">emanueletonello@gmail.com</a>&gt;<br>
Forked from: <a href="https://github.com/tistre/oracleeditor" title="OracleEditor.php homepage">OracleEditor.php</a> 1.20 &copy; 2006 by <a href="http://tim.digicol.de/" title="Tim Strehle's homepage on tim.digicol.de">Tim Strehle</a> &lt;<a href="mailto:tim@strehle.de" title="Send e-mail to Tim Strehle">tim@strehle.de</a>&gt;
</footer>
</body>
</html>
